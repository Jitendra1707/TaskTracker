...
function add() {
    ...
    if (value === "") {
        alert("Please write something, Task cannot be empty");
        return;
    }
    todoList.push({
        task: value,
    ...
    var todoSound = document.getElementById("todoSound");
    todoSound.play();
...
function addinmain(todoList) {
    ...
    todoList.forEach((element) => {
      ...
      <p id="task"> ${element.complete ? `<strike>${element.task}</strike>` : element.task
            } </p>
